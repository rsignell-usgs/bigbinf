...
\begin{figure}
	\centering
	\begin{subfigure}
		\includegraphics[height=0.35\textheight]{img/packets/6b.png}
	\end{subfigure}
	\begin{subfigure}
		\includegraphics[height=0.35\textheight]{img/packets/350Mb.png}
	\end{subfigure}
	\begin{subfigure}
		\includegraphics[height=0.35\textheight]{img/packets/2_4Gb.png}
	\end{subfigure}
...
\begin{figure}
	\centering
	\begin{subfigure}
		\includegraphics[width=0.5\textwidth]{img/speed_bytes/6b.png}
	\end{subfigure}
	\begin{subfigure}
		\includegraphics[width=0.5\textwidth]{img/speed_bytes/350Mb.png}
	\end{subfigure}
	\begin{subfigure}
		\includegraphics[width=0.5\textwidth]{img/speed_bytes/2_4Gb.png}
	\end{subfigure}
